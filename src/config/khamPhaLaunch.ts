// ============================================================
// Cờ trạng thái ấn phẩm "Bản Sắc Khám Phá" (/an-pham-ban-sac-kham-pha).
//
...
// docs/product/LAUNCH_CHECKLIST_KHAM_PHA.md — kể cả khi Kenji yêu cầu
