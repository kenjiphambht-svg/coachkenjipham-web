      ...
      <div className="min-h-screen bg-cream text-body-text">
        ...
        <section className="py-28 px-6 text-center bg-cream fade-in-section">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <h1 className="font-serif text-4xl md:text-[56px] leading-[1.2] text-ink max-w-3xl mx-auto">
        ...
        <section className="py-28 px-6 bg-[#f2ead8]">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-serif text-3xl md:text-[42px] text-center text-ink mb-16 fade-in-section">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-cream p-8 hover-lift fade-in-section shadow-sm">
                ...
                <p className="font-serif text-[17px] italic text-gold mb-3">
        ...
        <section className="py-28 px-6 bg-[#f2ead8] fade-in-section">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="bg-cream border-l-2 border-gold p-8 shadow-sm hover-lift">
              ...
              <p className="font-serif text-[17px] leading-relaxed italic">
        ...
        <section className="py-28 px-6 bg-dark-section">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16 fade-in-section">
              ...
              <h2 className="font-serif text-3xl md:text-[42px] text-cream-light mb-4">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 pb-2">
                      <h3 className="font-serif text-[19px] text-gold-brand mb-2">
                        {chapter.title}
                      </h3>
        ...
        <section className="py-28 px-6 bg-cream fade-in-section">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-serif text-3xl md:text-[42px] text-center text-ink mb-16">
        ...
        <section id="pricing" className="py-28 px-6 bg-[#f2ead8]">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16 fade-in-section">
              ...
              <p className="font-serif text-[15px] italic text-gold">
        ...
        <section className="py-28 px-6 bg-cream fade-in-section">
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              >
                <AccordionTrigger className="font-serif text-[17px] text-left hover:text-gold transition-colors">
