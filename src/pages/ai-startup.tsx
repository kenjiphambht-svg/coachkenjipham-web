      ...
      <div className="min-h-screen bg-cream text-body-text">
        ...
        <section className="pt-32 pb-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 px-4 py-1.5 border border-gold-brand/30 bg-gold-brand/5">
              <span className="text-xs tracking-widest text-gold-brand uppercase">Essence Coaching · AI Startup Dossier</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-ink mb-6 leading-tight">
              The AI-driven Personal Psychology Engine for self-awareness, emotional regulation, and action planning.
            </h1>
            
            <p className="text-lg md:text-xl text-body-text/90 mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button 
                onClick={() => scrollToSection("early-access")}
                className="bg-gold-brand hover:bg-gold text-ink px-8 py-6 text-base"
              >
              ...
              <Button 
                ...
                variant="outline"
                className="border-gold-brand/30 text-ink hover:bg-gold-brand/10 px-8 py-6 text-base"
              >
        ...
        <section className="py-24 px-6 bg-dark-section text-cream-light">
          <div className="max-w-4xl mx-auto text-center">
        ...
        <section id="technology" className="py-24 px-6 bg-dark-section text-cream-light">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-cream-light mb-12 text-center">
        ...
        <section id="safety" className="py-24 px-6 bg-dark-section text-cream-light">
        ...
        <section id="roadmap" className="py-24 px-6 bg-dark-section text-cream-light">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-cream-light mb-16 text-center">
              Roadmap.
            </h2>
        ...
        <section id="early-access" className="py-24 px-6">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-body-text/90 mb-12 text-center">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 border border-gold/30 bg-cream focus:outline-none focus:border-gold-brand transition-colors"
                ...
                <div>
                  <label htmlFor="reason" className="block text-sm font-medium text-ink mb-2">What brings you to Essence?</label>
                  <textarea
                    id="reason"
                    rows={4}
                    className="w-full px-4 py-3 border border-gold/30 bg-cream focus:outline-none focus:border-gold-brand transition-colors resize-none"
                ...
                <Button 
                  type="submit"
                  className="w-full bg-gold-brand hover:bg-gold text-ink py-6 text-base"
                  disabled
                >
                  Apply for Early Access
                </Button>

                <p className="text-xs text-center text-body-text/60">
                  Form integration pending — contact <a href="mailto:contact@coachkenjipham.com" className="text-gold-brand hover:underline">contact@coachkenjipham.com</a> directly for now.
                </p>
              </form>
            </Card>
          </div>
        ...
        <section className="py-24 px-6 bg-dark-section text-cream-light">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-serif text-cream-light mb-8">
              A human-centered AI company, built from Vietnam.
            </h2>

            <p className="text-lg text-cream-muted mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a href="mailto:contact@coachkenjipham.com">
                <Button 
                  variant="outline"
                  className="border-gold-brand/30 text-cream-light hover:bg-gold-brand/10 px-8 py-6 text-base w-full"
                >
        ...
        <footer className="py-12 px-6 border-t border-gold/20">
