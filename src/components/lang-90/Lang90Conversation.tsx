      ...
      <div className="mx-auto grid max-w-[1080px] gap-16 md:grid-cols-[0.8fr_minmax(0,1fr)] md:gap-20 md:items-start">
        <div className="md:col-start-2 md:row-start-1">
          ...
          <Lang90Reveal delay="short" className={`mt-12 ${bodyClass} space-y-8`}>
            ...
            <p>
              Không phải để sửa họ. Không phải để quyết định thay họ.
...
const journeySteps = [
  {
    ...
    paragraphs: [
      "Bạn không cần chuẩn bị một phiên bản gọn gàng của câu chuyện. Không cần biết đâu mới là nguyên nhân thật sự. Không cần kể mọi thứ theo đúng trình tự. Chúng ta bắt đầu từ điều đang khiến bạn phải có mặt ở đây lúc này.",
      "Có thể là một quyết định. Một mối quan hệ. Một phản ứng cứ lặp lại. Hoặc chỉ là cảm giác rất rõ rằng... mình không thể tiếp tục theo cách cũ mãi.",
      "Chúng ta bắt đầu từ nơi đang thật nhất, rồi để mọi thứ chậm lại đủ để nhìn.",
    ],
  },
  {
    title: "Hai — Nhìn ra điều đang nằm bên dưới",
    paragraphs: [
      "Điều đang kéo bạn đôi khi không phải câu chuyện trên bề mặt. Một cuộc trò chuyện có thể chạm vào nỗi sợ bị rời bỏ. Một quyết định công việc có thể bị che phủ bởi trách nhiệm, hình ảnh hoặc cảm giác mắc nợ. Một lần bị từ chối có thể khiến bạn nghi ngờ giá trị của chính mình.",
      "Khi tiếng ồn bớt đi, một vòng lặp, một kiểu phản ứng hoặc một mâu thuẫn chính bắt đầu hiện ra. Chúng ta không cần tìm ra mười vấn đề. Chỉ cần nhìn đủ rõ một điều đang thật sự dẫn cách bạn phản ứng lúc này.",
    ],
  },
  {
    title: "Ba — Đưa điều vừa thấy trở lại đời sống",
    paragraphs: [
      "Bạn không rời phiên chỉ với một cảm giác dễ chịu. Trước khi kết thúc, chúng ta sẽ cùng chọn một việc có thể thực hiện hoặc quan sát trong 48 giờ tiếp theo.",
      "Không phải thay đổi toàn bộ cuộc đời. Có thể chỉ là một cuộc trò chuyện cần được bắt đầu, một ranh giới cần được nói rõ, một quyết định cần thêm thời gian, hoặc một khoảnh khắc bạn nhận ra phản ứng cũ đang chuẩn bị xuất hiện... và dừng lại trước khi để nó quyết định thay mình.",
      "Một bước đủ nhỏ để thực hiện. Và đủ thật để bạn nhận ra mình đang bắt đầu lựa chọn khác đi.",
    ],
  },
];
