...
export default function FloatingZaloButton() {
  const ZALO_URL = 'https://zalo.me/PLACEHOLDER';
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#c9a84c] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
        <svg 
