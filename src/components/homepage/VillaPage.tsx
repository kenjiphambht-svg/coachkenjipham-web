    ...
    <>
      ...
      <main className="bg-e26-ivory text-e26-text">
        ...
        <section className="relative overflow-hidden border-y border-[#E0C068]/20 bg-[color-mix(in_srgb,var(--essence-white-2026)_48%,var(--essence-ivory-2026))] px-6 py-24 md:px-10 md:py-36">
          <div className="pointer-events-none absolute -left-[10%] top-[22%] h-[48%] w-[42%] rounded-full bg-[color-mix(in_srgb,var(--essence-white-2026)_58%,transparent)] blur-3xl" aria-hidden="true" />
          <div className="relative mx-auto max-w-6xl">
            <div className="e26-reveal max-w-[780px]">
              <h2 className="max-w-[700px] font-serif text-[40px] font-medium leading-[1.06] tracking-[-0.016em] md:text-[60px]">TỪ BẢN SẮC ĐẾN HIỆN THỰC.</h2>
              <p className="mt-7 font-sans text-[13px] font-semibold uppercase tracking-[0.12em] text-e26-text md:mt-8">NHẬN RA → LỰA CHỌN → HIỆN THỰC</p>
            </div>

            <div className="e26-reveal mt-14 grid gap-10 md:mt-20 md:grid-cols-[0.72fr_1.28fr] md:gap-24">
              <p className="max-w-[400px] font-serif text-[27px] font-medium leading-[1.42] tracking-[-0.01em] md:text-[33px]">Và một lựa chọn chỉ thật sự có ý nghĩa khi nó bắt đầu có mặt trong thực tế.</p>
        ...
        <section className="relative flex min-h-[72svh] items-center overflow-hidden bg-e26-black px-6 py-28 text-e26-ivory md:min-h-[82svh] md:px-10 md:py-40">
          ...
          <div
            ...
            style={{ background: "linear-gradient(to bottom, color-mix(in srgb, var(--essence-black-2026) 94%, transparent), color-mix(in srgb, var(--essence-black-2026) 74%, transparent) 45%, color-mix(in srgb, var(--essence-black-2026) 88%, transparent))" }}
            aria-hidden="true"
          />
        ...
        <section className="relative overflow-hidden px-6 py-24 md:px-10 md:py-36">
          <Image src="/images/home/two-paths-light-room.webp" alt="" fill sizes="100vw" className="object-cover object-center opacity-35" aria-hidden="true" />
          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            ...
            <div className="mt-14 grid gap-8 md:mt-20 md:grid-cols-2 md:gap-10">
              <Link href="/coaching" aria-label="Đi tới ESSENCE Coaching" className="group e26-reveal relative min-h-[430px] overflow-hidden border-t border-[color-mix(in_srgb,var(--essence-black-2026)_18%,transparent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-e26-gold focus-visible:ring-offset-4 focus-visible:ring-offset-e26-ivory md:min-h-[500px]">
                <Image src="/images/home/kitchen-morning.webp" alt="" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover object-center opacity-70 transition-transform duration-700 ease-out group-hover:scale-[1.025]" aria-hidden="true" />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, color-mix(in srgb, var(--essence-ivory-2026) 34%, transparent), color-mix(in srgb, var(--essence-ivory-2026) 90%, transparent) 62%, var(--essence-ivory-2026) 100%)" }} aria-hidden="true" />
                <div className="relative z-10 flex h-full min-h-[430px] flex-col justify-end px-6 py-8 md:min-h-[500px] md:px-9 md:py-10">
                  ...
                  <p className="mt-5 max-w-[470px] font-serif text-[28px] font-normal leading-[1.38] tracking-[-0.01em] md:text-[34px]">Khi điều cần nhìn rõ nằm trong đời sống của bạn — lựa chọn, mối quan hệ, vai trò, gia đình hay cách bạn đang sống với bản thân.</p>
              ...
              <Link href="/advisory" aria-label="Đi tới ESSENCE Advisory" className="group e26-reveal relative min-h-[430px] overflow-hidden border-t border-[color-mix(in_srgb,var(--essence-black-2026)_18%,transparent)] bg-[color-mix(in_srgb,var(--essence-white-2026)_68%,var(--essence-ivory-2026))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-e26-gold focus-visible:ring-offset-4 focus-visible:ring-offset-e26-ivory md:mt-14 md:min-h-[500px]">
                <div className="absolute inset-0 opacity-80" style={{ background: "linear-gradient(135deg, color-mix(in srgb, var(--essence-white-2026) 76%, transparent), transparent 58%), repeating-linear-gradient(0deg, transparent 0 46px, color-mix(in srgb, var(--essence-black-2026) 5%, transparent) 47px 48px)" }} aria-hidden="true" />
                <Image src="/images/advisory/advisory-essence-operating-loop-selected-v03.webp" alt="" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-contain object-[82%_26%] p-12 opacity-[0.12] transition-transform duration-700 ease-out group-hover:translate-x-1 group-hover:-translate-y-1 md:p-16" aria-hidden="true" />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 18%, color-mix(in srgb, var(--essence-ivory-2026) 50%, transparent) 54%, var(--essence-ivory-2026) 100%)" }} aria-hidden="true" />
                <div className="relative z-10 flex h-full min-h-[430px] flex-col justify-end px-6 py-8 md:min-h-[500px] md:px-9 md:py-10">
                  <p className="font-sans text-[11px] font-semibold uppercase tracking-[0.18em] text-e26-text-2">ESSENCE ADVISORY</p>
                  <p className="mt-5 max-w-[470px] font-serif text-[28px] font-normal leading-[1.38] tracking-[-0.01em] md:text-[34px]">Khi điều cần nhìn rõ nằm trong công việc hoặc doanh nghiệp — một bài toán quan trọng, quyết định có hệ quả, cách vận hành hay thay đổi cần được đưa vào thực tế.</p>
                  <span className={`${softLink} mt-8 w-fit`}>
        ...
        <section className="relative overflow-hidden bg-e26-white px-6 py-24 md:px-10 md:py-36">
          <Image src="/images/home/kenji-section-light-wall.webp" alt="" fill sizes="100vw" className="object-cover object-left opacity-80" aria-hidden="true" />
          <div className="absolute inset-0" style={{ background: "linear-gradient(90deg, color-mix(in srgb, var(--essence-cream-2026) 56%, transparent), color-mix(in srgb, var(--essence-cream-2026) 84%, transparent) 58%, color-mix(in srgb, var(--essence-ivory-2026) 94%, transparent))" }} aria-hidden="true" />
          ...
          <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-14 md:grid-cols-[0.7fr_1.3fr] md:gap-24">
            ...
            <div className="e26-reveal max-w-[690px] md:pt-8">
              <h2 className="font-serif text-[40px] font-medium leading-[1.08] tracking-[-0.016em] md:text-[56px]">VÌ SAO CẢ HAI CÙNG LÀ BẢN SẮC?</h2>
        ...
        {/* 07 — Open paths + reading return + trust */}
        <section className="relative overflow-hidden bg-e26-ivory px-6 py-24 md:px-10 md:py-40">
          <Image src="/images/home/ghi-chep-essence-v4.webp" alt="" fill sizes="100vw" className="object-cover object-center opacity-30" aria-hidden="true" />
          <div className="absolute inset-0 bg-[color-mix(in_srgb,var(--essence-ivory-2026)_70%,transparent)]" aria-hidden="true" />
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <div className="e26-reveal mt-20 border-t border-[#E0C068]/45 pt-10 md:mt-28 md:grid md:grid-cols-[1.1fr_0.9fr] md:gap-24 md:pt-14">
              <div className="hidden md:block" aria-hidden="true" />
              <aside className="md:border-l md:border-[#E0C068]/45 md:pl-12">
