...
// Cuối section: slot ảnh không khí 3:2 ngang rộng (chờ ảnh web-ready).
export default function WhatIsEssence() {
  return (
    <section className="bg-e26-ivory px-6 py-20 md:py-28">
      <div className="max-w-[1120px] mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="fade-in-section font-serif font-normal text-[28px] md:text-[40px] text-e26-text mb-8">
            Essence là gì?
          </h2>
        ...
        <div className="fade-in-section mt-16 md:mt-20">
          <ImageSlot ratio="3/2" label="Ảnh không khí — chờ bản web-ready" />
        </div>
      </div>
    </section>
  );
