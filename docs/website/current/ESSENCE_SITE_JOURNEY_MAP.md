...
|---|---|---|---|
| Villa entry | **L0:** / is the canonical public Villa route. | / | Renders the canonical Villa since P1 (PR #112 at 733b199). **07/08/2026 (L0 C-18):** /trang-chu-v2 is retired and removed (was: "remains contained evidence"). / is now the only Villa route; no redirect was authorized or added. |
...
|---|---|---|---|
| J-01 | ~~Root is a stub whose only CTA is /kidbook.~~ **Resolved by PR #112 (733b199):** root renders the canonical Villa with adult/parent/trust doors; the /kidbook CTA is gone. | None — closed. ~~/trang-chu-v2 post-cutover disposition remains a separate pending decision.~~ **Resolved 07/08/2026 (L0 C-18):** retired and removed. | Closed |
