...
- Essence is not medical therapy.
- Do not diagnose.
- Do not claim to treat, cure, or heal.
- Do not promise transformation.
- Do not replace professional mental health care.
- Do not use AI as an AI therapist.
- Do not frame astrology or symbolic mapping as fate prediction.
- Do not use fear-based selling.

## Practical Copy Rules

- Use reflective, observational, and choice-based language.
- Avoid medicalized claims.
