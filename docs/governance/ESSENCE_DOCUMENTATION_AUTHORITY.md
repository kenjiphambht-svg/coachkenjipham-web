...
This document governs how Essence documentation is ranked, read, changed, verified and archived. It prevents useful history from silently acting as current truth.

## Authority hierarchy

| Level | Meaning | Examples |
|---|---|---|
| L0 | Founder Decision | Explicit Kenji rulings recorded in the Conflict Register |
...
Higher level wins. A newer date does not win merely because it is newer.
...
Agents do not infer L0 from an old document, production implementation or a newer date.
...
Active documents record owner, decision scope, non-decision scope, last verified commit, review trigger and replacement where relevant.
