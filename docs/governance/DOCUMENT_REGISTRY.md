...
**baseline_evidence_commit** records the repository commit examined before a governance layer; it is not a claim that a new file existed at that commit. G0 files were finalized at merge commit **a45e4242c0e68f52e0004ee8dd5d02745e4212dd**. G1 audits that merged state as its evidence baseline. Before G1 merges, new or changed G1 records use **last_verified: G1 PR head; finalize at merge**; after merge, the merged commit SHA replaces that placeholder.
...
| docs/website/HANDOFF-trang-chu.md | homepage handoff | L5 / Historical / Kenji | handoff evidence / no current homepage truth | migration context / source dependencies | docs/website/current/ESSENCE_SITE_JOURNEY_MAP.md | no cadence |
