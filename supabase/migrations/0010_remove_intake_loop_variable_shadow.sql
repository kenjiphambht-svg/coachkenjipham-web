-- ============================================================
-- 0010 · Complete the 0009 lint remediation.
--
-- PL/pgSQL implicitly declares an integer FOR-loop iterator. Do not declare
-- it in the DECLARE block; using it inside the loop is sufficient and removes
-- both compiler diagnostics without changing the public RPC contract.
-- ============================================================
...
begin
  ...
  if not found then
    select request_hash, response into v_existing_request_hash, v_existing_response
