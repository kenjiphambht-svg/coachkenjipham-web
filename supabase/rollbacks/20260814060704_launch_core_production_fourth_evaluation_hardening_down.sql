-- Scoped rollback for 20260816040000_launch_core_production_fourth_evaluation_hardening.
-- Restores validate_job_scope() and validate_artifact_scope() to their
-- exact pre-fix bodies from 20260814034500_launch_core_production_job_
-- artifact_qa_foundation (unchanged by every migration between that one
-- and this one). Touches no other object, no other schema.
