...
(function () {
  ...
  function navView() { return ({'lang-detail':'lang','hatmam-detail':'hatmam',production:'hatmam',publication:'data-publication',deletion:'data-publication',audit:'data-publication',settings:'system',readiness:'system',contact:'system'})[data.view] || data.view; }
  ...
  function handleAction(id) {
    const updates = {
      'go-lang':()=>go('lang-detail'),'go-payment':()=>go('payments'),'go-deletion':()=>go('deletion'),'go-settings':()=>go('settings'),'go-hatmam-detail':()=>go('hatmam-detail'),'go-publication':()=>go('publication'),'go-audit':()=>go('audit'),'go-system':()=>go('system'),'go-readiness':()=>go('readiness'),'go-contact':()=>go('contact'),
